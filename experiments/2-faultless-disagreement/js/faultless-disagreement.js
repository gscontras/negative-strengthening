...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      condition = _.sample(["positive","negative"])
      ...
      $(".utterance1").html("\"That "+ stim.Noun + " " + this.verbs[0] + " " + stim.Predicate[condition] + ".\"");

      $(".utterance2").html("\"You're wrong. That "+ stim.Noun + " " + this.verbs[1] + " "  + stim.Predicate[condition] + ".\"");
...
//    },
    log_responses : function() {
        exp.data_trials.push({
          ...
          "adjective" : this.stim.Predicate[condition],
          "polarity"  : condition,
